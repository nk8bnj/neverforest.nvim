...
call everforest#highlight('MiniTablineHidden', s:palette.grey11, s:palette.bg2)
call everforest#highlight('MiniTablineModifiedCurrent', s:palette.blue, s:palette.bg4)
call everforest#highlight('MiniTablineModifiedHidden', s:palette.grey11, s:palette.bg2)
